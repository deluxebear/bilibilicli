export const commandRegistry = [
  ...
  "archive submit --filename <upos-filename> --title <title> --tid <id> --tags a,b",
  "video draft --file <path> --title <title> --tid <id> --tags a,b",
  "video run --file <path> --title <title> --tid <id> --tags a,b"
];
...
Commands:
  ...
  bilibilicli archive submit --filename <upos-filename> --title "标题" --tid 17 --tags tag1,tag2
  bilibilicli video draft --file ./video.mp4 --title "标题" --tid 17 --tags tag1,tag2
  bilibilicli video run --file ./video.mp4 --title "标题" --tid 17 --tags tag1,tag2
