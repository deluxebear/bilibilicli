export const commandRegistry = [
  ...
  "config list|get|set",
  "params copyright",
  "params types --compact",
  "params topics --tid <id> --title <title>",
  "params topics --keyword <keyword>",
  "params topic-info --topic-id <id>",
  ...
  "archive submit --filename <upos-filename> --title <title> --tid <id> --tags a,b --subtitle-lan en --topic-id <id> --mission-id <id>",
  "video draft --file <path> --title <title> --tid <id> --tags a,b --cover-file cover.jpg --subtitle-file sub.srt",
  "video run --file <path> --title <title> --tid <id> --tags a,b --cover-file cover.jpg --subtitle-file sub.srt --topic-id <id> --mission-id <id>"
];
...
Commands:
  ...
  bilibilicli archive submit --filename <upos-filename> --title "标题" --tid 17 --tags tag1,tag2 --subtitle-lan en --topic-id 1260884 --mission-id 4062466
  bilibilicli video draft --file ./video.mp4 --title "标题" --tid 17 --tags tag1,tag2 --cover-file ./cover.jpg --subtitle-file ./subtitle.en.srt
  bilibilicli video run --file ./video.mp4 --title "标题" --tid 17 --tags tag1,tag2 --cover-file ./cover.jpg --subtitle-file ./subtitle.en.srt --topic-id 1260884 --mission-id 4062466
